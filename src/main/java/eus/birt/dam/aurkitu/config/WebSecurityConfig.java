...
public class WebSecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						// Permitir Swagger en app desplegada
				...
				// Ejecutar el filtro JWT antes de comprobar si el usuario está logeado y meerlo en el contexto de
				// seguridad
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList(
				...
				"http://localhost", "https://localhost", // Es el que usa el emulador en Android Studio (Pixel con
															// Android 13)
				"capacitor://localhost"));
